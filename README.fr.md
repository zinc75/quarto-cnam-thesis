...
- Commentaires collaboratifs en marge via l'extension [`quarto-proofread-comments`](https://github.com/zinc75/quarto-proofread-comments), avec élargissement `wide_margins` (activé par défaut) appliqué **uniquement aux chapitres contenant réellement des commentaires**
